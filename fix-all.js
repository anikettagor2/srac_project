...
const replacements = [
    ...
    { from: /bg-white\/[0-9]+/g, to: 'bg-card' },
    { from: /text-zinc-200/g, to: 'text-foreground/90' },
    { from: /text-zinc-300/g, to: 'text-foreground/80' },
    { from: /text-zinc-[45678]00/g, to: 'text-muted-foreground' },
    { from: /bg-zinc-[678]00/g, to: 'bg-muted-foreground' },
    { from: /bg-black\/[0-9]+/g, to: 'bg-black/5 dark:bg-black/40' },
